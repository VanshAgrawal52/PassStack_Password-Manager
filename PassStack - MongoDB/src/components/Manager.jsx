    ...
    return (
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[80vh] ">
                <h1 className='text-4xl text font-bold text-center flex items-center justify-center gap-2 text-blue-700'>
                    <img className='w-10' src="../src/assets/logo.png" alt="PassStack Logo" />
                    PassStack
                </h1>
                <p className='text-blue-900 text-lg text-center'>Built to protect. Designed to remember.</p>
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        ...
                        <div className="relative">
                            ...
                            <span className='absolute right-[3px] top-[4px] cursor-pointer' onClick={showPassword}>
                                <img ref={ref} className='p-1' width={26} src="icons/eyecross.png" alt="eyecross" />
                            </span>
                        </div>

                    </div>
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-blue-500 hover:bg-blue-400 rounded-full px-8 py-2 w-fit border border-blue-900'>
                        <lord-icon
